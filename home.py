...
def home_page():
    ...
    cake_data = [
        ("hazelnutcake.jpg", "Hazelnut Cake"),
        ("chocolate_cake.jpg", "Chocolate Cake"),
        ("fruit_cake.jpg", "Fruit Cake"),
        ("custom_cake.jpg", "Custom Cake"),
        ("italianforest.jpg", "Italian Forest"),
        ("blackforest.jpg", "Black Forest"),
        ("icecream.jpg", "Ice Cream Cake"),
        ("redvelvet.jpg", "Red Velvet"),
        ("black_current.webp", "Black Current Cake"),
    ]
                ...
                with cols[j]:
                    ...
                    st.markdown(f"""
                        <a href="/pages/1_Store_Listings?cake={cake_link}" target="_self">
                            <img src="data:image/jpg;base64,{base64.b64encode(open('images/' + img, 'rb').read()).decode()}" class="cake-img">
                        </a>
